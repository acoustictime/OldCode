...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.textLabel.text = [photographer.name capitalizedString];
    cell.detailTextLabel.text = [NSString stringWithFormat:@"%d Photo%@",[photographer.photos count], [photographer.photos count] > 1 ? @"s" : @""];
