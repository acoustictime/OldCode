...
#define CORNER_FONT_RATIO 0.2
#define CORNER_MOVE_IN 2.0
...
- (void) drawPips
{
    ...
    if ((self.rank == 2) || (self.rank == 3) || (self.rank == 6) || (self.rank == 8) || (self.rank == 10)){
        [self drawPipsWithHorizontalOffset:0
...
- (void)drawCorners
{
    ...
    UIFont *cornerFont = [UIFont systemFontOfSize:self.bounds.size.width * CORNER_FONT_RATIO];
    ...
    CGRect textBounds;
    textBounds.origin = CGPointMake(CORNER_MOVE_IN, CORNER_MOVE_IN);
